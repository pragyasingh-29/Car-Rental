      ...
      <div class="container">
          <div class="row">
              ...
              <?php
                    ...
                    ?>
                  <table class="table-responsive table-striped table-content">
                      <thead>
                 ...
                 if(mysqli_num_rows($result1)>0){
                    ...
                    if($page>1){
                    echo '<li class="page-item"><a class="page-link" href="check_cars_available.php?page='.($page - 1).'">Prev</a></li>';
                    }
                    for($i=1;$i<=$total_page;$i++){
                        ...
                        echo '<li class="'.$active.' page-item"><a class="page-link" href="check_cars_available.php?page='.$i.'">'.$i.'</a></li>';
                    }
                    if($page<$total_page){
                    echo '<li class="page-item"><a class="page-link" href="check_cars_available.php?page='.($page + 1).'">Next</a></li>';
                    }
                    echo"</ul>";
                 }
                  ?>
